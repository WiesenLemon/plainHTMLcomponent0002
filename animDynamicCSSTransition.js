...
function AnimatedNodeItem(initnode, parent){
	...
	this.doTransform=function(dur, transform, timeing, linear, opacity, add){
		...
		var rule="-webkit-transition: " + dur + "; -moz-transition: " + dur + "; -ms-transition: " + dur + "; -o-transition: " + dur + "; transition: " + dur + ";" + trn1 + "-moz-transform" +  ": " + transform + ";" + "-webkit-transform" +  ": " + transform + ";" + "-o-transform" +  ": " + transform + ";" + "-ms-transform" +  ": " + transform + ";" + "transform" +  ": " + transform + "; " + getOpacityTransformString(opacity) + "; " + add + ";";
